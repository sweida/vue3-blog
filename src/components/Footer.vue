  ...
  <footer>
    <div class="foot-text">
      ...
      <p class="base">Crafted with <i class="iconfont lv-icon-aixin"></i> by
        ...
        <a class="green" href="https://github.com/sweida/vue-blog-index" target="_blank">Vue3</a>
      </p>
      <p>© 2018 - {{ year }} &nbsp;&nbsp;天行九歌 &nbsp;&nbsp;<a href="https://beian.miit.gov.cn/" target="_blank"
          style="color: #fff">粤ICP备2024211741号</a></p>
